...
\section{Investigación algoritmos de visión por computador} \label{aspc}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{DF_comparacionV2}
...
\begin{itemize}
	\item Velocímetros del porcentaje de exactitud medio, máximo y mínimo.
	\item Evolución del porcentaje de exactitud, y comparación con la media.
